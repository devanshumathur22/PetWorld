...
export default function Reviews() {
  const reviews = [
    { id:1, img: lab, text: "Got my Labrador from PetWorld. He’s super healthy!", name: "Priya Sharma" },
    ...
    <section id="Reviews" className="py-14 bg-gray-50">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map(r => (
            <div key={r.id} className="p-5 rounded-xl shadow hover:shadow-lg transition">
              <img src={r.img} alt="" className="w-80 h-32 rounded mb-3 object-cover" />
