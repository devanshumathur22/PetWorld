...
export default function DogCat() {
  const items = [
    { id:1, img: dog, title:"Golden Retriever", text:"Friendly & family-loving companion." },
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {items.map(i => (
            <div key={i.id} className="rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
              <img src={i.img} alt={i.title} className="w-full h-56 object-cover" />
              <div className="p-4">
