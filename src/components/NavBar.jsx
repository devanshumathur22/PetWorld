...
export default function Navbar() {
  ...
  return (
    <nav id="navbar" className="fixed top-0 left-0 w-full z-50 text-gray-700 bg-gray-50 shadow">
      <div className="flex justify-between items-center px-6 py-4 md:px-12">
        <h1 className="font-serif font-extrabold text-2xl text-gray-800">PetWorld</h1>
